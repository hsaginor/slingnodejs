...
public @interface V8ScriptEngineConfiguration {
	...
	@AttributeDefinition( 
			name = "Max Script Objects", 
			description = "Maximum per request non-primitive object references that can be passed from Java to NodeJS/V8 Scripts.",
			type = AttributeType.LONG,
			defaultValue = {""+V8ObjectWrapper.DEFAULT_MAX_CACHED_OBJECTS})
	public long maxScriptObjects();
}
